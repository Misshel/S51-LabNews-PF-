const Header = () =>{
  ...
  for (var i = 0; i < 2; i++) {
    ...
    if (i=0) {
      const iconMenu    = $('<div class="col s2"><a href="#" data-activates="slide-out" class="button-collapse"><img src="assets/img/menu.png" alt=""></a></div>');
      const section     = $('<div class="col s10">SECTION</div>');
      menuLength.append(iconMenu);
      menuLength.append(section);
    } else {
      const iconSearch    = $('<div class="col s2"><a href="#" data-activates="slide-out" class="button-collapse"><img src="assets/img/search.png" alt=""></a></div>');
  ...
  const iconFace   = $('<div class="col s2 offsetRight"><div class="col s4"><img src="assets/img/fb.png" alt=""></div></div>');
  const iconTwitter = $('<div class="col s2 offsetRight"><div class="col s4"><img src="assets/img/tw.png" alt=""></div></div>');
  const iconLinkdin = $('<div class="col s2 offsetRight"><div class="col s4"><img src="assets/img/in.png" alt=""></div></div>');
